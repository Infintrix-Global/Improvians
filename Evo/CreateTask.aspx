                            ...
                            <div class="request__body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-xl-3 mb-3">
                                        ...
                                        <asp:TextBox ID="txtGerDate" runat="server" class="jsDatePicker input__control robotomd"></asp:TextBox>
                                    </div>
                                    <div class="col-md-4 col-xl-3 mb-3">
                                        <label class="d-block">Number Of Trays To Inspect</label>
                                        <asp:TextBox ID="txtTGerTrays" runat="server" class="input__control robotomd"></asp:TextBox>
                                        <cc1:FilteredTextBoxExtender ID="Filteredtextboxextender1" runat="server"
                                            Enabled="True" TargetControlID="txtTGerTrays" FilterType="Numbers">
                            ...
                            <div class="request__body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-xl-3 mb-3">
                                        ...
                                        <asp:TextBox ID="txtFDate" runat="server" CssClass="jsDatePicker input__control"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-xl-3 mb-3">
                                        ...
                                        <asp:TextBox ID="txtFTrays" Enabled="false" runat="server" CssClass="input__control"></asp:TextBox>
                                        <cc1:FilteredTextBoxExtender ID="Filteredtextboxextender2" runat="server"
                                            Enabled="True" TargetControlID="txtFTrays" FilterType="Numbers">
                                        </cc1:FilteredTextBoxExtender>
                                    </div>
                                    <div class="col-lg-4 col-xl-3 mb-3">
                                    ...
                                    <div class="col-lg-4 col-xl-3 mb-3">
                                        ...
                                        <cc1:FilteredTextBoxExtender ID="Filteredtextboxextender4" TargetControlID="txtResetSprayTaskForDays" runat="server" Enabled="True" FilterType="Numbers" />

                                        <asp:TextBox ID="txtBenchIrrigationFlowRate" Visible="false" runat="server" CssClass="input__control"></asp:TextBox>
                                        <cc1:FilteredTextBoxExtender ID="Filteredtextboxextender5" TargetControlID="txtBenchIrrigationFlowRate" runat="server" Enabled="True" FilterType="Numbers" />
                                        <asp:TextBox ID="txtBenchIrrigationCoverage" Visible="false" runat="server" CssClass="input__control"></asp:TextBox>
                                        <cc1:FilteredTextBoxExtender ID="Filteredtextboxextender6" TargetControlID="txtBenchIrrigationCoverage" runat="server" Enabled="True" FilterType="Numbers" />
                                        <asp:TextBox ID="txtSprayCoverageperminutes" Visible="false" runat="server" CssClass="input__control"></asp:TextBox>
                                        <cc1:FilteredTextBoxExtender ID="Filteredtextboxextender7" TargetControlID="txtSprayCoverageperminutes" runat="server" Enabled="True" FilterType="Numbers" />
                                ...
                                <asp:Panel ID="pnlint" runat="server">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-xl-3 mb-3">
                                            ...
                                            <asp:TextBox ID="txtChemicalSprayDate" runat="server" CssClass="jsDatePicker input__control"></asp:TextBox>
                                            <span class="error_message"></span>
                                        </div>
                                        <div class="col-lg-4 col-xl-3 mb-3">
                                            <label>Trays</label>
                                            <asp:Label ID="lblUnMovedTrays" runat="server" Visible="false"></asp:Label>
                                            <asp:TextBox ID="txtChemicalTrays" Enabled="false" runat="server" CssClass="input__control"></asp:TextBox>
                                            <cc1:FilteredTextBoxExtender ID="Filteredtextboxextender8" TargetControlID="txtChemicalTrays" runat="server" Enabled="True" FilterType="Numbers" />
                                        ...
                                        <div class="col-lg-4 col-xl-3 mb-3">
                                            ...
                                            <asp:TextBox ID="txtResetChemicalSprayTask" runat="server" CssClass="input__control"></asp:TextBox>
                                            <cc1:FilteredTextBoxExtender ID="Filteredtextboxextender9" TargetControlID="txtResetChemicalSprayTask" runat="server" Enabled="True" FilterType="Numbers" />
                                        </div>
                                        <div class="w-100"></div>
                                        <div class="col-lg-4 col-xl-3 mb-3">
                                            <label>Comments </label>
                            ...
                            <div class="request__body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6 mb-3">
                                        ...
                                        <asp:TextBox ID="txtirrigationSprayDate" CssClass="jsDatePicker input__control" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6 mb-3">
                                        <label class="d-block">Minimum Days Until Next Irrigation</label>
                                        <asp:TextBox ID="txtirrigationResetSprayTaskForDays" runat="server" CssClass="input__control"></asp:TextBox>
                                        <cc1:FilteredTextBoxExtender ID="Filteredtextboxextender10" TargetControlID="txtirrigationResetSprayTaskForDays" runat="server" Enabled="True" FilterType="Numbers" />
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="request__body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 mb-md-0 col-12 col-md-auto">
                                        ...
                                        <asp:TextBox ID="txtPlantDate" runat="server" CssClass="jsDatePicker input__control"></asp:TextBox>
                                    </div>
                            ...
                            <div class="request__body">
                                ...
                                <asp:Panel ID="Panel3" runat="server">
                                    ...
                                    <span class="error_message">
                                        ...
                                        <div runat="server" id="Div1" class="col-12 col-md-4 col-lg-3 mb-3">
                                            <label>To Slot Position Start #</label>
                                            <asp:DropDownList ID="ddlToSlotPositionStart" runat="server" OnSelectedIndexChanged="ddlToSlotPositionStart_SelectedIndexChanged" AutoPostBack="true" class="custom__dropdown robotomd"></asp:DropDownList>
                                        </div>
                                        <div runat="server" id="Div2" class="col-12 col-md-4 col-lg-3 mb-3">
                                            <label>To Slot Position End #</label>
                                            <asp:DropDownList ID="ddlToSlotPositionEnd" runat="server" class="custom__dropdown robotomd"></asp:DropDownList>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-4 col-lg-3 mb-3">
                                            ...
                                            <asp:TextBox ID="txtMoveDate" runat="server" CssClass="jsDatePicker input__control"></asp:TextBox>
                                            <span class="error_message"></span>
                            ...
                            <div class="request__body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-4 col-lg-3 mb-3">
                                        ...
                                        <asp:TextBox ID="txtDumpDate" runat="server" CssClass="jsDatePicker input__control"></asp:TextBox>
                                    </div>
                                    <div class="col-12 col-md-4 col-lg-3 mb-3">
                                        <label>Quantity of Tray </label>
                                        <asp:TextBox ID="txtQuantityofTray" runat="server" CssClass="input__control"></asp:TextBox>
                                        <cc1:FilteredTextBoxExtender ID="Filteredtextboxextender11" TargetControlID="txtQuantityofTray" runat="server" Enabled="True" FilterType="Numbers" />
                                    </div>
                                    <div class="d-none d-sm-block w-100"></div>
                                    <div class="col-12 col-md-4 col-lg-3 mb-3">
                                        <label>Comments </label>
                                            ...
                                            <asp:Panel ID="Panel1" runat="server">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-4 col-lg-3 mb-3">
                                                        ...
                                                        <asp:TextBox ID="txtgeneralDate" runat="server" class="jsDatePicker input__control robotomd"></asp:TextBox>
                                                        <span class="error_message">
                            ...
                            <div class="request__body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 mb-md-0 col-12 col-md-auto">
                                        ...
                                        <asp:TextBox ID="txtCropHealthDate" runat="server" CssClass="jsDatePicker input__control"></asp:TextBox>
                                    </div>
                                    <div class="d-none d-sm-block w-100"></div>
                                    <div class="mb-3 col-12 col-md-auto">
                                        <label>Comments </label>
