                            ...
                            <div class="col-12 col-sm">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">This is
                                        <asp:Label runat="server" ID="lblName1" />
                                        from Growers Transplanting Team, let me know how may I assist you.</p>
                                    <div class="sales__contact">
                                        <p class="mb-1">
                                            <a class="bttn-link" runat="server" id="lnkPhone" href="tel:+14564564565">
                                                ...
                                                <span>
                                                    <asp:Label runat="server" ID="lblPhone" /></span>
                                            </a>
                                        </p>
                                        <p>
                                            <a class="bttn-link" runat="server" id="lnkEmail" href="mailto:janedoe@growerstransplanting.com">
                                                ...
                                                <span>
                                                    <asp:Label runat="server" ID="lblEmail" /></span>
                                            </a>
                                        </p>
                                    </div>
                                </div>
