    ...
    public class BAL_CommonMasters
    {
        ...
        public DataTable GetSeedLot(string JobCode)
        {
            ...
            try
            {
                ...
                if (JobCode == "JB0200002" || JobCode == "JB0200003" || JobCode == "JB0200004" || JobCode == "JB0200005" || JobCode == "JB0200006")
        ...
        public DataTable GetLocationTEST()
        {
            Evo_General objGeneral = new Evo_General();
            DataTable dt = new DataTable();
            try
            ...
            //  strQuery = "Select s.[Position Code], s.[Position Code] BenchName, s.[Location Code] as Facility  from [GTI$IA Subsection] s where Level in (2,3) and s.[Location Code] = '" + MainLocation + "'  AND s.[Position Code] Not in ('" + MainLocation + "') ";
                    ...
                    strQuery = "Select s.[Position Code], s.[Position Code] BenchName, s.[Location Code] as Facility  from [GTI$IA Subsection] s where Level in (3) ";
