    ...
    <div class="site__container">pt>
        ...
        <div class="row">
            ...
            <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
                ...
                <asp:ListBox ID="ddlBenchLocation" SelectionMode="Multiple" AutoPostBack="true" OnSelectedIndexChanged="ddlBenchLocation_SelectedIndexChanged" runat="servr"  CssClass="SelectBox custom__dropdown robotomd"></asp:ListBox>
            ...
            <div class="portlet-body">
                <div class="data__table">
                    <asp:GridView ID="gvFer" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        class="striped" AllowSorting="true" PageSize="10" DataKeyNames="GreenHouseID,jobcode,ChemicalCode,jid,TaskRequestKey,AssignedBy" OnRowDataBound="gvFer_RowDataBound"
