...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="site__container">
        ...
        <p class="pt-3">The list of tasks below are items for you to complete. For each task, you will either be completing the task or reviewing it and assigning it to someone else. Most of these tasks are auto-generated by system based on the plant's production profile schedule after it is seeded. You also have the ability to manually request using 'Create Task' or assign tasks as needed - just go into the form and choose.</p>
        <div class="text-sm-right">
            <asp:Button Text="Pull Data" ID="btnSubmit" Visible="false" CssClass="ml-2 submit-bttn bttn bttn-primary" OnClick="btnSubmit_Click" runat="server" />
        </div>
