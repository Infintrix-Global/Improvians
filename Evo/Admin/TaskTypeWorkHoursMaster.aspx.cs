...
namespace Evo.Admin
{
    public partial class TaskTypeWorkHoursMaster : System.Web.UI.Page
    {
        ...
        public void GetTaskTypeList()
        {
            ...
            dt = objCommon.GetAllTaskTypeWorkHourList();
            gvChemical.DataSource = dt;
            gvChemical.DataBind();
            count.Text = "Number of Task Type Work Hours =" + dt.Rows.Count;
        ...
        protected void btAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                TaskTypeWorkHoursMasters obj = new TaskTypeWorkHoursMasters()
                {
                    TaskType = txtName.Text,
                    TaskHours = Convert.ToInt16(txtTaskHours.Text),
                    IsActive = true,
                ...
                if (Session["tasktypeId"] != null)
                {
                    ...
                    obj.id = x;
                    _isInserted = objCommon.UpdateTaskTypeWorkHoursMaster(obj);
                }
                else
                {
                    _isInserted = objCommon.InsertTaskTypeWorkHoursMaster(obj);
                }
        ...
        protected void GridEmployee_RowCommand(object sender, GridViewCommandEventArgs e)
        {
...

            {
                ...
                int eid = Convert.ToInt32(e.CommandArgument);
                Session["tasktypeId"] = eid;
                objCommon.RemoveTaskTypeWorkHours(eid);
                GetTaskTypeList();
            }
        }
        ...
        {
            DataTable dtSearch1;
            string sqr = "Select * FROM TaskWorkHours WHERE ISActive = 1";
