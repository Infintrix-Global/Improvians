    ...
    public partial class ForgetPassword : System.Web.UI.Page
    {
        ...
        protected void btnChange_Click(object sender, EventArgs e)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                msg = msg + "Your password to access portal is: " + objCom.Decrypt(ReceiverPassword) + "<br />";

                msg = msg + "<br />Thanks, <br/> Growers Transplanting, Inc Portal";
                objGen.SendMail(ReceiverEmail, "", Subject, msg);

                string message = "Thank you for your request. Password has been sent to you over an email.";
