                        ...
                        <div class="request__body">
                            ...
                            <div class="row">
                                <div class="mb-xl-3 col-12 col-xl-6 align-self-end">
                                    <asp:Button Text="Submit" ID="btngerminationSumit" CssClass="bttn bttn-primary bttn-action" runat="server" />
                                    <asp:Button Text="Reset" ID="btngerminationReset" runat="server"  CssClass="bttn bttn-primary bttn-action" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="request__body">
                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="mb-md-3 col-xl-3 col-md-6 col-12 align-self-end">
                                    ...
                                    <asp:Button Text="Submit"  CausesValidation="true" ID="btnFSubmit" CssClass="mr-2 bttn bttn-primary" runat="server" />

                                    <asp:Button Text="Reset" ID="btnFReset" runat="server" CssClass="bttn bttn-primary"  />
                                </div>
                        ...
                        <div class="request__body">
                           ...
                           <%-- <div class="row align-items-end">--%>
                                ...
                                <asp:Panel ID="pnlint" runat="server">
                                    ...
                                    <div class="row">
                                        <div class="col-auto">
                                            <asp:Button Text="Submit"  CausesValidation="true" ID="btnChemicalSubmit" CssClass="bttn bttn-primary bttn-action mr-2" runat="server"  />

                                            <asp:Button Text="Reset" ID="btnChemicalReset" runat="server" CssClass="bttn bttn-primary bttn-action"  />
                                        </div>
                                    </div>
                                </asp:Panel>
                        ...
                        <div class="request__body">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-xl-3 col-12 col-xl-6 align-self-end">
                                    ...
                                    <asp:Button Text="Submit" ID="btnirrigationSubmit" CssClass="ml-2 submit-bttn bttn bttn-primary" runat="server"  />

                                    <asp:Button Text="Reset" ID="btnirrigationReset" runat="server" CssClass="submit-bttn bttn bttn-primary" />
                        ...
                        <div class="request__body">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 mb-md-0 col-12 col-md-auto align-self-end">
                                    <asp:Button Text="Submit" ID="btnplant_readySubmit" CssClass="ml-2 submit-bttn bttn bttn-primary" runat="server"  />

                                    <asp:Button Text="Reset" ID="btnplant_readyReset" runat="server" CssClass="submit-bttn bttn bttn-primary"  />
                                ...
                                <asp:Panel ID="Panel5" runat="server">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col m3">
                                            ...
                                            <asp:DropDownList ID="ddlToFacility" runat="server" class="custom__dropdown robotomd" AutoPostBack="true" ></asp:DropDownList>
                                            <span class="error_message">
                                    ...
                                    <div class="row">
                                        <div class="col-auto">
                                            ...
                                            <asp:Button Text="Submit" ValidationGroup="e" CausesValidation="true" ID="btnMoveSubmit"  CssClass="bttn bttn-primary bttn-action" runat="server"  />
                                        </div>
                                        <div class="col-auto">

                                            <asp:Button Text="Reset" ID="MoveReset" runat="server" CssClass="bttn bttn-primary bttn-action"  />
                                        </div>
                                    </div>
                                </asp:Panel>
                            </div>
                                                    ...
                                                    <asp:Panel ID="Panel6" runat="server">
                                                        <div class="row" style="margin-left: 15px;">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <asp:DropDownList ID="ddlTaskType" runat="server" AutoPostBack="true" class="custom__dropdown robotomd">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <asp:DropDownList ID="ddlAssignments" runat="server" AutoPostBack="true"  class="custom__dropdown robotomd"></asp:DropDownList>
                                                                <span class="error_message">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div style="margin-top: 9%;">
                                                                    <asp:Button Text="Send Email" ID="btnSendMail" CssClass="ml-2 submit-bttn bttn bttn-primary" runat="server"  />
