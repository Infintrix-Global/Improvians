...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="header__bottom">
        <div class="header__tabs header__tabs-scroll">
            <ul class="d-flex align-items-center justify-content-sm-center list-inline">
        ...
        <div class="site__container">
            ...
            <div class="portlet light pt-3 mb-4">
                ...
                <div class="portlet-body">
                    ...
                    </div> <!-- data__table ends -->
                </div><!-- portlet-body ends -->
            </div><!-- portlet light ends -->
        </div> <!-- site__container ends -->
    </div><!-- main ends -->
</asp:Content>
