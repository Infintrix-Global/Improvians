<%@ Page Title="" Language="C#" MasterPageFile="~/EvoMaster.Master" AutoEventWireup="true" CodeBehind="ChemicalTaskReq.aspx.cs" Inherits="Improvians.ChemicalTaskReq" %>
            ...
            <%-- <asp:UpdatePanel ID="up1" runat="server">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <asp:Button ID="btnManual" runat="server" Text="Manual Request" CssClass="bttn bttn-primary bttn-action" OnClick="btnManual_Click1" />
