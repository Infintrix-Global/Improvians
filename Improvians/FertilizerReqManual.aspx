                    ...
                    <asp:Panel ID="pnlint" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <asp:TextBox ID="txtTrays" TextMode="Number" runat="server" Enabled="false" CssClass="input__control" AutoPostBack="true" OnTextChanged="txtTrays_TextChanged"></asp:TextBox>
                                <span class="error_message">
