<%@ Page Title="" Language="C#" MasterPageFile="~/EvoMaster.Master" AutoEventWireup="true" CodeBehind="ChemicalTaskViewDetails.aspx.cs" Inherits="Evo.ChemicalTaskViewDetails" %>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Job No." ItemStyle-Width="10%" HeaderStyle-CssClass="autostyle2">
                                        <ItemTemplate>
                                         ...
                                         <%--   <asp:Label ID="lblFertilizationId" runat="server" Text='<%# Eval("ChemicalId")  %>' Visible="false"></asp:Label>--%>
