        ...
        <div class="site__container">
            ...
            <div class="dashboard__grid">
                <div class="dashboard__box">
                    ...
                    <div class="dashboard__box-desc">
                        <div class="dashboard__box-count dash_green_txt robotobold">
                            <asp:LinkButton ID="lnkPutAway" PostBackUrl="~/GrowerPutAwayForm.aspx" runat="server" Text="0"></asp:LinkButton>
                        </div>
                ...
                <div class="dashboard__box">
                    ...
                    <div class="dashboard__box-desc">
                        <div class="dashboard__box-count dash_blue_txt robotobold">
                            <asp:LinkButton ID="lnkGerm" PostBackUrl="~/GerminationRequestForm.aspx" runat="server" Text="0"></asp:LinkButton>
                        </div>
                ...
                <div class="dashboard__box">
                    ...
                    <div class="dashboard__box-desc">
                        <div class="dashboard__box-count dark_txt robotobold">
                             <asp:LinkButton ID="lnkFer" PostBackUrl="~/FertilizerTaskReq.aspx" runat="server" Text="0"></asp:LinkButton>
                        </div>
                ...
                <div class="dashboard__box">
                    ...
                    <div class="dashboard__box-desc">
                        <div class="dashboard__box-count dash_blue_txt robotobold">
                             <asp:LinkButton ID="lnkIrr" PostBackUrl="~/IrrigationRequestForm.aspx" runat="server" Text="0"></asp:LinkButton>
                        </div>
                ...
                <div class="dashboard__box">
                    ...
                    <div class="dashboard__box-desc">
                        <div class="dashboard__box-count dash_blue_txt robotobold">
                             <asp:LinkButton ID="lnkpr" PostBackUrl="~/PlantReadyRequestForm.aspx" runat="server" Text="0"></asp:LinkButton>
                        </div>
                ...
                <div class="dashboard__box">
                    ...
                    <div class="dashboard__box-desc">
                        <div class="dashboard__box-count dash_green_txt robotobold">
                            <asp:LinkButton ID="lnkMove" PostBackUrl="~/MoveForm.aspx" runat="server" Text="0"></asp:LinkButton>
                        </div>
