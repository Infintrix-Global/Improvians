<%@ Page Title="" Language="C#" MasterPageFile="~/EvoMaster.Master" AutoEventWireup="true" CodeBehind="MoveReqAsssignment.aspx.cs" Inherits="Evo.MoveReqAsssignment" %>
            ...
            <div class="row">
                                ...
                                <asp:GridView ID="gvFer" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Job No." ItemStyle-Width="10%" HeaderStyle-CssClass="autostyle2">
                                            <ItemTemplate>
                                                <asp:Label ID="lblMoveID" runat="server" Text='<%# Eval("ID")  %>' Visible="false"></asp:Label>
                ...
                <div id="userinput" runat="server" visible="false">
                    ...
                    <asp:Panel ID="pnlint" runat="server">
                        ...
                        <div class="portlet-body">
                            <div class="data__table">
                                <asp:GridView ID="GridMoveDetails" runat="server" AutoGenerateColumns="False"
