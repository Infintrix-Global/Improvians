<%@ Page Title="" Language="C#" MasterPageFile="~/EvoMaster.Master" AutoEventWireup="true" CodeBehind="ProductionPlannerTaskCompletionForm.aspx.cs" Inherits="Evo.ProductionPlannerTaskCompletionForm" %>
                            ...
                            <asp:GridView ID="gvGerm" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Planned Due Date" HeaderStyle-CssClass="autostyle2">
                                        <ItemTemplate>
                                            <asp:Label ID="Label12" runat="server" Text='<%# Eval("due_date","{0:MM/dd/yyyy}")  %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                ...
                <asp:Panel ID="pnlint" runat="server">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="d-flex">
                                <label>Is the tray size [<asp:Label ID="lbltraysizecon" runat="server"></asp:Label>
                                    ] correct?</label>
                            ...
                            <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="false" class="striped data__table w-auto"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="">
                                        <ItemTemplate>
                                            <asp:Label ID="lblID" runat="server" Text='<%#Bind("[SeedID]")  %>' Visible="false"></asp:Label>
                                            <asp:Label ID="lblLotName" Text='<%# Bind("[SeedLot]")  %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
