                                ...
                                <h3 class="robotobold">
                                    ...
                                    <div class="col m3">
                                      ...
                                      <asp:RadioButtonList ID="radtype"  runat="server" OnSelectedIndexChanged="radtype_SelectedIndexChanged" AutoPostBack="true" RepeatDirection="Horizontal">
                                          ...
                                          <asp:ListItem Text="Fertilizer" Value="Fertilizer"  Selected="True"></asp:ListItem>
                                      </asp:RadioButtonList>
                                    </div>
                                    ...
                                    <div class="data__table">
                                        ...
                                        <asp:Panel ID="pnlPoints" runat="server" CssClass="pnlpoint">
                                            <asp:GridView runat="server" ID="gvFerDetails" AutoGenerateColumns="false" class="Grid1"
