<%@ Page Title="" Language="C#" MasterPageFile="~/EvoMaster.Master" AutoEventWireup="true" CodeBehind="FertilizerRequestForm.aspx.cs" Inherits="FertilizerRequestForm" %>
                ...
                <div id="userinput" runat="server" class="assign__task d-flex" visible="false">
                    <asp:Panel ID="pnlint" runat="server">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4 col-lg-3">
                                <label><asp:Label ID="lbltype" runat="server" Text="Fertilizer"></asp:Label></label>
