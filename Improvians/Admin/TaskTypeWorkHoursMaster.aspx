<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="TaskTypeWorkHoursMaster.aspx.cs" Inherits="Evo.Admin.TaskTypeWorkHoursMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="admin__content">
        <div class="container-fluid">
            <h1 class="text-center text-sm-left">Task Type Work Hours</h1>
                ...
                <div class="filter__row d-flex">
                    <div class="row">
                        <div class="col m3">
                            ...
                            <asp:TextBox ID="txtName" class="input__control" placeholder="Enter Task type" runat="server"></asp:TextBox>
                            <span class="error_message">
                             ...
                             <label>Task Hours<span style="color: red">*</span></label>
                            <asp:TextBox ID="txtTaskHours" class="input__control" TextMode="Number" placeholder="Enter Task hours" runat="server"></asp:TextBox>
                            <span class="error_message">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTaskHours" ValidationGroup="e"
                                    SetFocusOnError="true" ErrorMessage="Please Enter Task Type" ForeColor="Red"></asp:RequiredFieldValidator>
                                ...
                                <div class="data__table">
                                    <asp:GridView ID="gvChemical" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Task Type" ItemStyle-Width="50%" HeaderStyle-CssClass="autostyle2" SortExpression="TaskType">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label7" runat="server" Text='<%# Eval("TaskType")  %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Task Hours" ItemStyle-Width="50%" HeaderStyle-CssClass="autostyle2" SortExpression="TaskType">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTaskHours" runat="server" Text='<%# Eval("TaskHours")  %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="" HeaderStyle-CssClass="autostyle2">
                                                <ItemTemplate>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <asp:ImageButton ID="imgDelete" runat="server" CommandArgument='<%# Eval("ID")  %>' CommandName="RemoveProfile" ImageUrl="~/Admin/images/delete.png" AlternateText="delete" ToolTip="delete" OnClientClick="return confirm('Are you sure you want to remove this tasktype?');"></asp:ImageButton>
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
