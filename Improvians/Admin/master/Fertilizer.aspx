<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Fertilizer.aspx.cs" Inherits="Evo.Admin.Fertilizer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="admin__content">
        <div class="container-fluid">
            <h1 class="text-center text-sm-left">View Fertilizer</h1>
            ...
            <hr />
                    ...
                    <asp:Panel ID="pnlAdd" runat="server" Visible="false">
                        ...
                        <label>
                            <h3>IsActive</h3>
                            <asp:CheckBox ID="chkIsActive" TabIndex="4" runat="server" Checked="true"></asp:CheckBox>
                    ...
                    <asp:Panel ID="pnlList" runat="server" Visible="true">
                        <div class="filter__row d-flex">
                            <div class="row">
                                <div class="col m3">
                                    <label>Name </label>
                                    <asp:TextBox ID="TextBox1" runat="server" CssClass="input__control "></asp:TextBox>
                                </div>
                                            ...
                                            <div class="data__table">
                                                <asp:GridView ID="gvFertilizer" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Fertlizer Name" HeaderStyle-CssClass="autostyle2" SortExpression="EmployeeName">
                                                            <ItemTemplate>
